        ...
        <div class="uk-width-1-1">
            <div class="md-card uk-margin-medium-bottom">
                ...
                <div class="md-card-content">
                    {!! Form::open(array('route' => 'roles.store', 'method'=>'POST', 'id'=>'form_validation', 'class'=>'uk-form-stacked', 'novalidate'=>'')) !!}
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-medium-1-2">
                            <div class="form-group">
                                ...
                                @foreach($permission as $value)
                                    <p>
                                       {{ Form::checkbox('permission[]', $value->id, false, array('class' => 'name','data-md-icheck')) }}
