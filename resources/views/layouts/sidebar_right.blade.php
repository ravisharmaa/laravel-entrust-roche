            ...
            <li>
                <div class="timeline timeline_small uk-margin-bottom">
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="timeline_content">Deleted post <a href="#"><strong>Voluptatum placeat ducimus deleniti quisquam ipsam.</strong></a></div>
                    </div>
                    <div class="timeline_item">
                        ...
                        <div class="timeline_content">
                            ...
                            <div class="timeline_content_addon">
                                <img src="{{ asset('alt_air/assets/img/gallery/Image16.jpg') }}" alt=""/>
                            </div>
                        </div>
                    </div>
                    <div class="timeline_item">
                        ...
                        <div class="timeline_content">
                            New comment on post <a href="#"><strong>Veniam voluptatum dolores fuga ipsum suscipit.</strong></a>
                            <div class="timeline_content_addon">
                                <blockquote>
                                    Quia maiores est perspiciatis sunt dolores veniam.&hellip;
                                </blockquote>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul class="md-list md-list-addon">
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            <span class="md-list-heading">Marcelina Hyatt</span>
                                            <span class="uk-text-small uk-text-muted">Sed cumque vel magnam et.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                ...
                <ul class="md-list md-list-addon chat_users">
                    <li>
                        ...
                        <div class="md-list-content">
                            ...
                            <span class="md-list-heading">Candida Nader</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Cumque ut.</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-addon-element">
                        ...
                        <div class="md-list-content">
                            <div class="md-list-action-placeholder"></div>
                            <span class="md-list-heading">Laney Roberts</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Ut ea cum.</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-addon-element">
                            <span class="element-status element-status-danger"></span>
                            <img class="md-user-image md-list-addon-avatar" src="{{ asset('alt_air/assets/img/avatars/avatar_04_tn.png') }}" alt=""/>
                        </div>
                        <div class="md-list-content">
                            <div class="md-list-action-placeholder"></div>
                            <span class="md-list-heading">Wilma Schaden</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Est et atque.</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-addon-element">
                        ...
                        <div class="md-list-content">
                            <div class="md-list-action-placeholder"></div>
                            <span class="md-list-heading">Maggie Smitham</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Accusantium nihil.</span>
                        </div>
                    </li>
                </ul>
                    ...
                    <div class="chat_box chat_box_colors_a">
                        <div class="chat_message_wrapper">
                            <div class="chat_user_avatar">
                                <img class="md-user-image" src="{{ asset('alt_air/assets/img/avatars/avatar_11_tn.png') }}" alt=""/>
                            </div>
                        ...
                        <div class="chat_message_wrapper chat_message_right">
                            <div class="chat_user_avatar">
                                <img class="md-user-image" src="{{ asset('alt_air/assets/img/avatars/avatar_03_tn.png') }}" alt=""/>
                            </div>
                            <ul class="chat_message">
                                <li>
                                    <p>
