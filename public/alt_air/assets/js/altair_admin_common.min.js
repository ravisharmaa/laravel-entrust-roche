...
function detectIE() {
    var e = window.navigator.userAgent,
        i = e.indexOf("MSIE ");
    return 0 < i ? parseInt(e.substring(i + 5, e.indexOf(".", i)), 10) : 0 < e.indexOf("Trident/") ? (i = e.indexOf("rv:"), parseInt(e.substring(i + 3, e.indexOf(".", i)), 10)) : (i = e.indexOf("Edge/"), 0 < i && parseInt(e.substring(i + 5, e.indexOf(".", i)), 10))
}
...
$(function() {
    ...
    this.setup = function() {
        ...
        return function() {
            ...
            var i = this.$wrapper,
                a = this.$input;
            a.attr("title") && i.attr("title", a.attr("title")).attr("data-uk-tooltip", a.attr("data-uk-tooltip"))
        }
    }()
...
altair_page_onload = {
    ...
    dynamic_fields: function() {
        ...
        $("[data-dynamic-fields]").each(function() {
            ...
            e(i, a), i.on("click", ".btnSectionClone", function(t) {
                t.preventDefault(), i.find(".btnSectionClone").replaceWith('<a href="#" class="btnSectionRemove"><i class="material-icons md-24">&#xE872;</i></a>');
    ...
    card_progress: function(e, i, a) {
        ...
        t.each(function() {
            var e = $(this),
                t = i ? parseInt(i) : parseInt(e.attr("data-toolbar-progress")),
    ...
    fab_speed_dial: function() {
        function e(e) {
            ...
            a.toggleClass("md-fab-active"), i.velocity({
                scale: 0
            }, {
                duration: 140,
                easing: easing_swiftOut,
    ...
    content_preloader_show: function(e, i, a, t, n) {
        if (!$body.find(".content-preloader").length) {
            var s = isHighDensity() ? "@2x" : "",
                ...
                d = "undefined" != typeof a ? $(a) : $body;
            d.append('<div class="content-preloader content-preloader-' + i + '" style="height:' + n + "px;width:" + t + "px;margin-left:-" + t / 2 + 'px">' + r + "</div>"), setTimeout(function() {
    ...
    color_picker: function(e, i, a) {
        if (e) {
            for (var t = randID_generator(), n = i ? i : ["#e53935", "#d81b60", "#8e24aa", "#5e35b1", "#3949ab", "#1e88e5", "#039be5", "#0097a7", "#00897b", "#43a047", "#689f38", "#ef6c00", "#f4511e", "#6d4c41", "#757575", "#546e7a"], s = n.length, r = $('<div class="cp_altair" id="' + t + '"/>'), d = 0; d < s; d++) {
        ...
        $("[data-accordion-section-open]").each(function() {
            ...
            setTimeout(function() {
                ...
                if (sectOpen = i.accordionSectionOpen.toString().split(","), e.children(".uk-accordion-title.uk-active").each(function() {
                        $(this).trigger("click")
                    }), !i.accordion.options.collapse && sectOpen.length > 1)
                    for (var a = 0; a <= sectOpen.length; a++) e.children(".uk-accordion-title").eq(sectOpen[a] - 1).trigger("click");
                else e.children(".uk-accordion-title").eq(sectOpen[0] - 1).trigger("click")
            }, 220)
        })
    }
};