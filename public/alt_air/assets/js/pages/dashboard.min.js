$(function() {
    ...
    video_player: function() {
        ...
        e.length && (t.on("click", "li", function(i) {
            i.stopPropagation();
            var n = $(this);
            if (!n.hasClass(a)) {
                var r = n.attr("data-video-src"),
                    s = "https://www.youtube.com/embed/" + r + "?rel=0";
                t.children("li").removeClass(a), n.addClass(a), e.velocity({
                    translateZ: 0,
                    scale: 0,
                    opacity: 0
                }, {
                    ...
                    complete: function() {
                        e.children("iframe").attr("src", s), setTimeout(function() {
                            e.velocity("reverse")
                        }, 280)
                    }
                })
